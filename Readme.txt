...
The two versions of the songs with the same name under each folder represent the original key and the key estimated by ASKE individually that was rated as the most pleasing.
